// Terms and Conditions Component for IPTV DRM Stream Player (Video)
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <p>
        ...
        related to it, still belong to IndoVerseID.
      </p>

      <p>
        IndoVerseID is committed to ensuring that the app is as useful and efficient as possible. For
      ...
      <p>
        The IPTV DRM Stream Player (Video) app stores and processes personal data that you have
        provided to us, in order to provide my Service. It’s your responsibility to keep your phone
        ...
        mean that the app won’t work properly or at all.
      </p>
      ...
      <p>
        You should be aware that there are certain things that IndoVerseID will not take
        ...
        provider, but IndoVerseID cannot take responsibility for the app not working at full
      ...
      <p>
        Along the same lines, IndoVerseID cannot always take responsibility for the way you use the
        app i.e. You need to make sure that your device stays charged – if it runs out of battery
        and you can’t turn it on to avail the Service, IndoVerseID cannot accept responsibility.
      </p>

      <p>
        With respect to IndoVerseID’s responsibility for your use of the app, when you’re using the
        ...
        we can make it available to you. IndoVerseID accepts no liability for any loss, direct or
      ...
      <p>
        ...
        to keep using the app. IndoVerseID does not promise that it will always update the app so
      ...
      <p>
        ...
        contact me at indoverseid@gmail.com.
      </p>
    </div>
  );
};
